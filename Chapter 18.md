...
**5. List the views of implementing the monitoring and reporting function based on the security performance metrics. (per SP 800-55) **

**1. Prepare for data collection.** In essence, this step involves the metrics development
process shown in Figure 18.2.
...
1. *Identify key stakeholders* and/or partners across the organization who regularly deal with institutional compliance issues (for example, legal, risk management,
privacy, audit).
...
5. Develop a compliance policy, standard, roles and responsibilities, and/or procedures
